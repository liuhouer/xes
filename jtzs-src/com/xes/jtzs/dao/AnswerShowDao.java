 ...
 */
@Repository
public class AnswerShowDao extends BaseHibernateDao<AnswerShow,java.lang.Long>{

	@SuppressWarnings({ "unchecked" })
	public Class getEntityClass() {
		return AnswerShow.class;
	}
	
	@SuppressWarnings({ "unchecked" })
	public Page findPage(AnswerShowQuery query) {
        StringBuilder sql = new StringBuilder("select t from AnswerShow t where 1=1 ");

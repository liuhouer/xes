 ...
 */
@Repository
public class GradeSubjectDao extends BaseHibernateDao<GradeSubject,java.lang.Long>{
	...
	public Page findPage(GradeSubjectQuery query) {
        StringBuilder sql = new StringBuilder("select t from GradeSubject t where 1=1 ");

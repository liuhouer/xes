...
@Controller
@RequestMapping("/jtzs/commonRule")
public class CommonRuleController extends BaseRestSpringController<CommonRule,java.lang.Long>{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	private CommonRuleManager commonRuleManager;
	
	private final String LIST_ACTION = "redirect:/jtzs/commonRule";
	...
	public String index(ModelMap model,CommonRuleQuery query,HttpServletRequest request,HttpServletResponse response) {
		Page page = this.commonRuleManager.findPage(query);
		
		model.addAllAttributes(toModelMap(page, query));
		return "/jtzs/commonRule/index";
	}

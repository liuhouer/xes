...
@Controller
@RequestMapping("/jtzs/teacherStatistics")
public class TeacherStatisticsController extends BaseRestSpringController<TeacherStatistics,java.lang.Long>{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	private TeacherStatisticsManager teacherStatisticsManager;
	
	private final String LIST_ACTION = "redirect:/jtzs/teacherStatistics";
	...
	public String index(ModelMap model,TeacherStatisticsQuery query,HttpServletRequest request,HttpServletResponse response) {
		Page page = this.teacherStatisticsManager.findPage(query);
		
		model.addAllAttributes(toModelMap(page, query));
		return "/jtzs/teacherStatistics/index";
	}
	...
	public String show(ModelMap model,@PathVariable java.lang.Long id) throws Exception {
		...
		return "/jtzs/teacherStatistics/show";
	}
	...
	public String _new(ModelMap model,TeacherStatistics teacherStatistics,HttpServletRequest request,HttpServletResponse response) throws Exception {
		model.addAttribute("teacherStatistics",teacherStatistics);
		return "/jtzs/teacherStatistics/new";
	}
	...
	public String edit(ModelMap model,@PathVariable java.lang.Long id) throws Exception {
		TeacherStatistics teacherStatistics = (TeacherStatistics)teacherStatisticsManager.getById(id);
		model.addAttribute("teacherStatistics",teacherStatistics);
		return "/jtzs/teacherStatistics/edit";
	}

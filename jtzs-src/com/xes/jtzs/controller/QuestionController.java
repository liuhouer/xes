...
@Controller
@RequestMapping("/jtzs/question")
public class QuestionController extends BaseRestSpringController<Question,java.lang.Long>{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	private QuestionManager questionManager;
	
	private final String LIST_ACTION = "redirect:/jtzs/question";
	...
	public String index(ModelMap model,QuestionQuery query,HttpServletRequest request,HttpServletResponse response) {
		Page page = this.questionManager.findPage(query);
		
		model.addAllAttributes(toModelMap(page, query));
		return "/jtzs/question/index";
	}

...
@Controller
@RequestMapping("/jtzs/eventSendToUser")
public class EventSendToUserController extends BaseRestSpringController<EventSendToUser,java.lang.Long>{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	private EventSendToUserManager eventSendToUserManager;
	
	private final String LIST_ACTION = "redirect:/jtzs/eventSendToUser";
	...
	public String index(ModelMap model,EventSendToUserQuery query,HttpServletRequest request,HttpServletResponse response) {
		Page page = this.eventSendToUserManager.findPage(query);
		
		model.addAllAttributes(toModelMap(page, query));
		return "/jtzs/eventSendToUser/index";
	}
	...
	public String show(ModelMap model,@PathVariable java.lang.Long id) throws Exception {
		...
		return "/jtzs/eventSendToUser/show";
	}
	...
	public String _new(ModelMap model,EventSendToUser eventSendToUser,HttpServletRequest request,HttpServletResponse response) throws Exception {
		model.addAttribute("eventSendToUser",eventSendToUser);
		return "/jtzs/eventSendToUser/new";
	}
	...
	public String edit(ModelMap model,@PathVariable java.lang.Long id) throws Exception {
		EventSendToUser eventSendToUser = (EventSendToUser)eventSendToUserManager.getById(id);
		model.addAttribute("eventSendToUser",eventSendToUser);
		return "/jtzs/eventSendToUser/edit";
	}

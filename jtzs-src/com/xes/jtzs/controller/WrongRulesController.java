...
@Controller
@RequestMapping("/jtzs/wrongRules")
public class WrongRulesController extends BaseRestSpringController<WrongRules,java.lang.Long>{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	private WrongRulesManager wrongRulesManager;
	
	private final String LIST_ACTION = "redirect:/jtzs/wrongRules";
	...
	public String index(ModelMap model,WrongRulesQuery query,HttpServletRequest request,HttpServletResponse response) {
		Page page = this.wrongRulesManager.findPage(query);
		
		model.addAllAttributes(toModelMap(page, query));
		return "/jtzs/wrongRules/index";
	}

 ...
 */
@Controller
@RequestMapping("/admin/jtzs/answerShow")
public class AdminAnswerShowController extends BaseRestSpringController<AnswerShow,java.lang.Long>{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	private AnswerShowManager answerShowManager;
	
	private final String LIST_ACTION = "redirect:/admin/jtzs/answerShow";
	...
	public String index(ModelMap model,AnswerShowQuery query,HttpServletRequest request,HttpServletResponse response) throws IOException {
		Page page = this.answerShowManager.findPage(query);
		
		 this.addShowLabelAttrbite("/admin/jtzs/answerShow", request, response);
		
		model.addAllAttributes(toModelMap(page, query));
		return "/admin/jtzs/answerShow/index";
	}
	...
	public String show(ModelMap model,@PathVariable java.lang.Long id) throws Exception {
		...
		return "/admin/jtzs/answerShow/show";
	}
	...
	public String _new(ModelMap model,AnswerShow answerShow,HttpServletRequest request,HttpServletResponse response) throws Exception {
		model.addAttribute("answerShow",answerShow);
		return "/admin/jtzs/answerShow/new";
	}
	...
	public String edit(ModelMap model,@PathVariable java.lang.Long id) throws Exception {
		AnswerShow answerShow = (AnswerShow)answerShowManager.getById(id);
		model.addAttribute("answerShow",answerShow);
		return "/admin/jtzs/answerShow/edit";
	}
	...
	public String tabEdit(ModelMap model,@PathVariable java.lang.Long id) throws Exception {
		AnswerShow answerShow = (AnswerShow)answerShowManager.getById(id);
		model.addAttribute("answerShow",answerShow);
		return "/admin/jtzs/answerShow/tab_edit";
	}
	...
	public String tabShow(ModelMap model,@PathVariable java.lang.Long id) throws Exception {
		AnswerShow answerShow = (AnswerShow)answerShowManager.getById(id);
		model.addAttribute("answerShow",answerShow);
		return "/admin/jtzs/answerShow/tab_show";
	}

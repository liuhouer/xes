...
@Controller
@RequestMapping("/jtzs/answer")
public class AnswerController extends BaseRestSpringController<Answer,java.lang.Long>{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	private AnswerManager answerManager;
	
	private final String LIST_ACTION = "redirect:/jtzs/answer";
	...
	public String index(ModelMap model,AnswerQuery query,HttpServletRequest request,HttpServletResponse response) {
		Page page = this.answerManager.findPage(query);
		
		model.addAllAttributes(toModelMap(page, query));
		return "/jtzs/answer/index";
	}

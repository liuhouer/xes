...
@Controller
@RequestMapping("/jtzs/subject")
public class SubjectController extends BaseRestSpringController<Subject,java.lang.Long>{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	private SubjectManager subjectManager;
	
	private final String LIST_ACTION = "redirect:/jtzs/subject";
	...
	public String index(ModelMap model,SubjectQuery query,HttpServletRequest request,HttpServletResponse response) {
		Page page = this.subjectManager.findPage(query);
		
		model.addAllAttributes(toModelMap(page, query));
		return "/jtzs/subject/index";
	}

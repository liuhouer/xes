...
@Controller
@RequestMapping("/jtzs/scoreLog")
public class ScoreLogController extends BaseRestSpringController<ScoreLog,java.lang.Long>{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	private ScoreLogManager scoreLogManager;
	
	private final String LIST_ACTION = "redirect:/jtzs/scoreLog";
	...
	public String index(ModelMap model,ScoreLogQuery query,HttpServletRequest request,HttpServletResponse response) {
		Page page = this.scoreLogManager.findPage(query);
		
		model.addAllAttributes(toModelMap(page, query));
		return "/jtzs/scoreLog/index";
	}

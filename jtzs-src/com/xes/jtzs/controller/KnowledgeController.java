...
@Controller
@RequestMapping("/jtzs/knowledge")
public class KnowledgeController extends BaseRestSpringController<Knowledge,java.lang.Long>{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	private KnowledgeManager knowledgeManager;
	
	private final String LIST_ACTION = "redirect:/jtzs/knowledge";
	...
	public String index(ModelMap model,KnowledgeQuery query,HttpServletRequest request,HttpServletResponse response) {
		Page page = this.knowledgeManager.findPage(query);
		
		model.addAllAttributes(toModelMap(page, query));
		return "/jtzs/knowledge/index";
	}

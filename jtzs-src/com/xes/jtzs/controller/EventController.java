...
@Controller
@RequestMapping("/jtzs/event")
public class EventController extends BaseRestSpringController<Event,java.lang.Long>{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	private EventManager eventManager;
	
	private final String LIST_ACTION = "redirect:/jtzs/event";
	...
	public String index(ModelMap model,EventQuery query,HttpServletRequest request,HttpServletResponse response) {
		Page page = this.eventManager.findPage(query);
		
		model.addAllAttributes(toModelMap(page, query));
		return "/jtzs/event/index";
	}

...
@Controller
@RequestMapping("/jtzs/gradeSubject")
public class GradeSubjectController extends BaseRestSpringController<GradeSubject,java.lang.Long>{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	private GradeSubjectManager gradeSubjectManager;
	
	private final String LIST_ACTION = "redirect:/jtzs/gradeSubject";
	...
	public String index(ModelMap model,GradeSubjectQuery query,HttpServletRequest request,HttpServletResponse response) {
		Page page = this.gradeSubjectManager.findPage(query);
		
		model.addAllAttributes(toModelMap(page, query));
		return "/jtzs/gradeSubject/index";
	}

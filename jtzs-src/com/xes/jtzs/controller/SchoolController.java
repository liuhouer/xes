...
@Controller
@RequestMapping("/jtzs/school")
public class SchoolController extends BaseRestSpringController<School,java.lang.Long>{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	private SchoolManager schoolManager;
	
	private final String LIST_ACTION = "redirect:/jtzs/school";
	...
	public String index(ModelMap model,SchoolQuery query,HttpServletRequest request,HttpServletResponse response) {
		Page page = this.schoolManager.findPage(query);
		
		model.addAllAttributes(toModelMap(page, query));
		return "/jtzs/school/index";
	}

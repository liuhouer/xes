...
如果您的页面没有反映，请点击 <a style="color:#FF0000" href="${referer}">返回上一页</a> <a  style="color:#FF0000" href="<%=path%>">返回首页</a>  
</c:when>
<c:otherwise>
<script type="text/javascript">
var timer = 3;
...
如果您的页面没有反映，请点击  <a style="color:#FF0000" href="<%=path%>">返回首页</a>  <a style="color:#FF0000" href="${ctx}/admin/login">管理员登陆</a>
</c:otherwise>
</c:choose>
</div>
</up72:override>

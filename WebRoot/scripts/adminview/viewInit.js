 ...
 */
(function($) {
	function loadAdminView(opt){
		var scripts = $("script[src]");
		var loadJs = [
			"/scripts/main.js",
			"/scripts/weebox/bgiframe.js",
			"/scripts/weebox/weebox.js",
			"/scripts/adminview/adminview.js"
		];
		var loadCss = [
			"/scripts/weebox/weebox.css",
			"/scripts/adminview/adminview.css"
		];
		...
		var loadInterval = window.setInterval(function(){
			if(typeof($.adminViews) != "undefined" 
				...
				$.adminViews.initAdminView(opt.pageTemplateId);
			}
			if(timeoutnum <= 0){
				window.clearInterval(loadInterval);
	...
	$(document).ready(function(){
		...
		if(_href.indexOf("?") != -1){
			...
			opt += "}";
			opt = eval("("+opt+")");
			if(typeof(opt.pageTemplateId)!="undefined" 
				&& opt.pageTemplateId!=null && opt.pageTemplateId!=""){
				loadAdminView(opt);
			}
		}
	});

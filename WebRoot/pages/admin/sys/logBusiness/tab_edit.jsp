...
<div class="up72_edit skin_edit">
  <form:form id="admin_sys_logBusiness_tab_edit_form" method="put" action="${ctx}/admin/sys/logBusiness/${logBusiness.id}" modelAttribute="logBusiness">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_sys_logBusiness_tab_edit_form").validate({
				/*  
				// ajax提交方式

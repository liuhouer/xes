...
<div id="TabDemo_<%= id%>" class="infoContent" style="visibility:visible; opacity:1;">
        <div class="up72_tabs">      
			  <!-- tab start -->
             <div class="tabs_con"> 
				  <span  rel="${ctx}/admin/sys/dataChangLog/<%=id %>/tabShow"><a href="javascript:;">基本信息</a></span>
				  <span  rel="${ctx}/admin/sys/dataChangLog/<%=id %>/tabEdit"><a href="javascript:;">编辑</a></span>
			  </div>
              <!-- tab end -->
       </div>
</div>

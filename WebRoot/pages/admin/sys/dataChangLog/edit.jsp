...
<div class="up72_edit">
  <form:form id="admin_sys_dataChangLog_edit_form" method="put" action="${ctx}/admin/sys/dataChangLog/${dataChangLog.id}" modelAttribute="dataChangLog">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_sys_dataChangLog_edit_form").validate({
				/*  
				// ajax提交方式

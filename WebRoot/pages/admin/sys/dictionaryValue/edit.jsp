...
<div class="up72_edit">
  <form:form id="admin_sys_dictionaryValue_edit_form" method="post" action="${ctx}/admin/sys/dictionaryValue/doEdit" modelAttribute="dictionaryValue">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_sys_dictionaryValue_edit_form").validate();	
	});
</script>
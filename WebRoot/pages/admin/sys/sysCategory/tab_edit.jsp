...
<div class="up72_edit">
  <form:form id="admin_sys_sysCategory_tab_edit_form" method="put" action="${ctx}/admin/sys/sysCategory/${sysCategory.id}" modelAttribute="sysCategory">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_sys_sysCategory_tab_edit_form").validate({
			/*  
			// ajax提交方式

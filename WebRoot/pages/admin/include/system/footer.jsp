...
<!--
<div class="up72_dofooter skin_dofooter" id="footer_product">
    <div class="up72_dofcopyright" id="macdock">  
-->  
        <div class="up72_navl dock-container" style="display:none;"><jsp:include page="/admin/menu/nav?AUTH_PRODUCT_ID=${AUTH_PRODUCT.id}" flush="true" /></div>
<!--
        <div class="up72_copbg"></div>        
    </div>
</div>

...
<div class="up72_edit">
  <form:form id="admin_auth_workGroup_edit_form" method="post"
		action="${ctx}/admin/auth/workGroup" modelAttribute="workGroup">
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#submitButton").bind("click",function(){
			$("#admin_auth_workGroup_edit_form").submit();
		});
	});
	function submitRecommendForm(){
		...
		$.ajax({
			url : "${ctx}/admin/auth/workGroup",
			type : "post",
			data : $("#admin_auth_workGroup_edit_form").serialize(),
			dataType : "json",

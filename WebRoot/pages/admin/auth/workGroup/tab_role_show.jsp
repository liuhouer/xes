...
<div class="up72_show">
  <table cellspacing="0" cellpadding="0" border="0" width="100%" class="show_table">
   ...
   <div class="up72_submit">
     ...
     <div class="btn btn_sub" title="删除"><input type="button" id="" name="" onclick="deleteRole(${role.id },'wg',${orgId});" value="删除" /></div>
     <div class="btn btn_cel" title="返回"><input type="button" id="" value="返回" onclick="showPro('${ctx}/admin/auth/workGroup/${orgId}/roleList')" /></div>
   </div>
</div>

...
<!-- END  当前位置 -->
<form id="admin_auth_product_page_form" name="admin_auth_product_page_form" action="${ctx}/admin/auth/permission/getData">
  	<table id="gridTable">
		<thead>
			<tr>
	...
	<div class="up72_quickbtns">
		...
		<div class="btn btn_sub" title="下一步"><input type="button"  value="下一步" onclick="getData();"/></div>
	</div>
</form>
<script type="text/javascript">
	// 列选择显示处理

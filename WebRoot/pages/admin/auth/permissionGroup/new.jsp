...
<div class="up72_edit">
  <form:form id="admin_auth_permissionGroup_edit_form" method="post" action="${ctx}/admin/auth/permissionGroup" modelAttribute="permissionGroup" >
...
<script type="text/javascript">
	...
	function submitRecommendForm(){
		alert("提交服务器处理中，请等待。<img style='vertical-align:bottom;' src='/scripts/weebox/img/loading.gif' width='30' height='30' />");
		$.ajax({
			url : "${ctx}/admin/auth/permissionGroup",
			type : "post",

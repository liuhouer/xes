    ...
    <tr>
      <td><div class="op_area">
          <table cellspacing="2" cellpadding="0" border="0" width="100%">
            ...
            <tr>
              <td class="func"><a onclick="show('${ctx}/admin/auth/permissionGroup/new','<%=PermissionGroup.TABLE_ALIAS%>添加',600)" href="javascript:;" class="sysiconBtn addorder">添加</a></td>
            </tr>
          </table>
        </div></td>
      <td><div class="op_area">
          <table cellspacing="0" cellpadding="0" border="0" width="100%">
            ...
            <tr>
              <td class="func"><span  onclick="doRestBatchDelete('${ctx}/admin/auth/permissionGroup','items',document.forms.admin_auth_permissionGroup_page_form)" class="sysiconBtn delete">删除</span>
			  <a href="javascript:" onclick="doRestBatchEdit({url:'/admin/auth/permissionGroup/batchEdit',batchBox:'items',form:'#admin_auth_permissionGroup_batchEdit_form'})"  class="sysiconBtn edit">批量编辑</a></td>
            </tr>
          </table>
        </div></td>
      <td><div class="op_area">
            ...
            <tr>
              <td class="func">
                  ...
                  <div id="search_button_rel" style="display:none; position:absolute;" class="finder_filter_pos">
                    ...
                    <table>
						<tr>	
							<td class="tdLabel"><%=PermissionGroup.ALIAS_NAME%>：</td>		
							<td> </td>
						</tr>	
				 </table> 
				  ...
				  <table>
						<tr>	
							...
							<select id="searchColumn" name="searchColumn" onchange="syncValue(this,'#searchColumnSel')">
								 <option value="name" <c:if test="${'name' eq query.searchColumn}"> selected</c:if>><%=PermissionGroup.ALIAS_NAME%></option>
                          </select>：</td>		
							<td>
				 ...
				 <input type="submit" class="sysiconBtnNoIcon"  value="查询" onclick="getReferenceForm(this).action='${ctx}/admin/auth/permissionGroup'"/>
                    </div>
                  </div>
                  <!--end高级查询层-->
                    ...
                    <table cellspacing="0" cellpadding="0" border="0" width="100%">
                      <tr>
                        <td><select id="searchColumnSel" name="searchColumnSel"  onchange="syncValue(this,'#searchColumn')">
								 <option <c:if test="${'name' eq query.searchColumn}"> selected</c:if> value="name"><%=PermissionGroup.ALIAS_NAME%></option>
                          </select></td>
                        ...
                        <td><input type="submit" class="sysiconBtnNoIcon"  value="查询" onclick="getReferenceForm(this).action='${ctx}/admin/auth/permissionGroup'"/></td>
                      </tr>
                    </table>
                  </div>
                </td>

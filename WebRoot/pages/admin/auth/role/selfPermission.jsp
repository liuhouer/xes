  ...
  <c:when test="${null!=productList && fn:length(productList)>0}">
    <form action="${ctx}/admin/auth/role/${role.id}/assignPerm" id="op_role_permission_form" name="op_role_permission_form" method="post">
      ...
      <table cellpadding="0" cellspacing="0" width="100%" style="margin-top:10px">
        <tr>
          <td width="33%" valign="top"><%@include file="include/selfMenuPermTree.jsp" %></td>
          <td width="33%" valign="top"><%@include file="include/selfOptionPermTree.jsp" %></td>
          <td width="33%" valign="top"><%@include file="include/selfTabPermTree.jsp" %></td>
        </tr>
      </table>

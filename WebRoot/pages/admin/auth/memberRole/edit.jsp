...
<div class="up72_edit">
  <form:form id="admin_auth_memberRole_edit_form" method="put" action="${ctx}/admin/auth/memberRole/${memberRole.id}" modelAttribute="memberRole">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_auth_memberRole_edit_form").validate();	
	});
</script>
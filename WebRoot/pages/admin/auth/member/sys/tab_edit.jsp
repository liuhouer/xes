...
<form:form id="admin_auth_member_tab_edit_form" method="put" action="${ctx}/admin/auth/member/${authUser.id}" modelAttribute="authUser">
    ...
    <input type="hidden" id="flag" name="flag" value="/sys"/>
  <div class="up72_edit">
		...
		<td>
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0" class="show_table">
				<tbody><tr>
					...
					<td width="61%" id="tdUserName"><input type="text" class="{required:true} input_txt" id="userName" name="userName" readonly="readonly" value="${authUser.userName}" />
					<span class="required">*</span>
					</td>
				</tr>
				<tr>
					<td height="30" align="right"><%=AuthUser.ALIAS_NICK_NAME%>：</td>
					<td><input type="text" name="nickName" id="nickName" value="${authUser.nickName}" class="{required:true} input_txt" maxlength="20" />
					<span class="required">*</span>
					</td>
				</tr>
				<tr id="tr_Password2">
					<td height="30" align="right"><%=AuthUser.ALIAS_PASSWORD%>：</td>
					<td><input type="text" class="input_txt"  id="password" name="password" readonly="readonly" class="{required:true} input_txt" value="${authUser.password}" />
					<span class="required">*</span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><form:input path="problem" id="problem" class="{required:true,minlength:4,maxlength:50,cname:true} input_txt" />
					<span class="required">*</span>
					 <font color='red'>
				...
				<tr>
					...
					<td><form:input path="anser" id="anser" class="{required:true,minlength:4,maxlength:50,cname:true} input_txt" />
					<span class="required">*</span>
					<font color='red'>

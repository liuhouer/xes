...
<div class="up72_edit">
  <form:form id="admin_auth_member_edit_form" method="put" action="${ctx}/admin/auth/member/${authUser.id}" modelAttribute="authUser">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_auth_member_edit_form").validate();	
	});
</script>
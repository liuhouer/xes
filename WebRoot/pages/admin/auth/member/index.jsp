...
<div class="head_content">
   		<div class="navBar"> » <a class="" href="${ctx}/admin/auth/member" ><%=AuthUser.TABLE_ALIAS%>列表</a></div>
</div>
<!-- END 当前位置 -->
<!--查询-->
<div class="up72_search">
  <form method="get" id="admin_auth_member_search_form" name="admin_auth_member_search_form" action="${ctx}/admin/auth/member">
  	...
  	<table id="gridTable">
		<thead>
			<tr>
				...
				<th showColumn="code" sortColumn="CODE" width="60" style="display: none;"><%=AuthUser.ALIAS_CODE%></th>
				<th showColumn="lastIp" sortColumn="LAST_IP" width="120" style="display: none;"><%=AuthUser.ALIAS_LAST_IP%></th>
				<th showColumn="lastVisiTime" sortColumn="LAST_VISI_TIME" width="120"  style="display: none;"><%=AuthUser.ALIAS_LAST_VISI_TIME%></th>
				<th showColumn="email" sortColumn="EMAIL" width="220"><%=AuthUser.ALIAS_EMAIL%></th>
				<th showColumn="mobile" sortColumn="MOBILE" width="120"  style="display: none;"><%=AuthUser.ALIAS_MOBILE%></th>
				<th showColumn="enabled" sortColumn="ENABLED" width="50" style="display: none;"><%=AuthUser.ALIAS_ENABLED%></th>
				<th showColumn="problem" sortColumn="PROBLEM" width="320"  ><%=AuthUser.ALIAS_PROBLEM%></th>
				<th showColumn="anser" sortColumn="ANSER" width="320"><%=AuthUser.ALIAS_ANSER%></th>
			</tr>
		</thead>
		<tbody>

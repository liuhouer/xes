...
<div id="TabDemo_${member.id}">
	...
	<c:choose>
		...
		<c:otherwise>
			...
			<div class="tabs_con"> 
				<perm:tag selector="span[rel]" replace="${ctx},${member.id}">
			        <span rel="${ctx}/admin/auth/member/${member.id}/tabShow" style="display:none;" id="RoleView"><a href="javascript:;">返回</a></span>
				 </perm:tag>
				 <perm:tag selector="span[rel]" replace="${ctx},${member.id}">
			        <span rel="${ctx}/admin/auth/member/${member.id}/tabEdit" style="display:none;" id="RoleEdit"><a href="javascript:;">编辑</a></span>
				</perm:tag>
				<perm:tag selector="span[rel]" replace="${ctx},${member.id}">
				<span class="hand current" rel="${ctx}/admin/auth/member/${member.id}/tabShow"><a href="javascript:;">基本信息</a></span>
				</perm:tag>
				<perm:tag selector="span[rel]" replace="${ctx},${member.id}">

...
<div class="up72_edit">
	<form:form id="admin_auth_productAbout_edit_form" method="post" action="${ctx}/admin/auth/productAbout/" modelAttribute="productAbout" >
	...
	$(document).ready(function(){
		$("#admin_auth_productAbout_edit_form").validate({
				...
				submitHandler:function(form){
					...
					$.ajax({
						"url" : "${ctx}/admin/auth/productAbout/",
						"type" : "post",

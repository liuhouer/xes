...
<div class="up72_edit">
  <form:form id="admin_auth_organization_edit_form" method="post" action="${ctx}/admin/auth/organization/create" modelAttribute="organization" >
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$("#submitButton").bind("click",function(){
			$("#admin_auth_organization_edit_form").submit();
		});
	});
	function submitRecommendForm(){
		...
		$.ajax({
			url : "${ctx}/admin/auth/organization",
			type : "post",
			data : $("#admin_auth_organization_edit_form").serialize(),
			dataType : "json",

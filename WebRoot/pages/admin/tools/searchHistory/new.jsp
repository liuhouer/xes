...
<div class="up72_edit">
  <form:form id="admin_tools_searchHistory_edit_form" method="post" action="${ctx}/admin/tools/searchHistory/" modelAttribute="searchHistory" >
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_tools_searchHistory_edit_form").validate();	
	});
</script> 

...
<div class="up72_edit">
  <form:form id="admin_lucene_searchHistory_edit_form" method="put" action="${ctx}/admin/lucene/searchHistory/${searchHistory.id}" modelAttribute="searchHistory">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_lucene_searchHistory_edit_form").validate();	
	});
</script>
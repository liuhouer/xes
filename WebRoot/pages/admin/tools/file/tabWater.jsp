...
<form id="file_zoom_form" name="file_zoom_form">
  <div class="up72_edit">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="edit_table">
      <tr class="pb_frmtr">
        <th class="pb_frmth"><label>水印类型:</label></th>
        <td class="pb_frmtd"> 文字
          <input type="radio" checked="checked" id="type1" name="type" value="1" />
          图片
          <input type="radio" id="type2" name="type" value="2" /></td>
      </tr>
      <tr class="pb_frmtr">
        <th class="pb_frmth"><label>水印值:</label></th>
        <td class="pb_frmtd"><input type="text" class="input_txt" id="value" name="value" />
          <a href="javascript:;">文件</a></td>
      </tr>
      <tr>

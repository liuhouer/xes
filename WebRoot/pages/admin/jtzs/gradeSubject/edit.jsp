...
<div class="up72_edit">
  <form:form id="admin_jtzs_gradeSubject_edit_form" method="put" action="${ctx}/admin/jtzs/gradeSubject/${gradeSubject.id}" modelAttribute="gradeSubject">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_jtzs_gradeSubject_edit_form").validate({
			/*  
			// ajax提交方式

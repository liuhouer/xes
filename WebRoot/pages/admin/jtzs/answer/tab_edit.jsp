...
<div class="up72_edit">
  <form:form id="admin_jtzs_answer_tab_edit_form" method="put" action="${ctx}/admin/jtzs/answer/${answer.id}" modelAttribute="answer">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_jtzs_answer_tab_edit_form").validate({
			/*  
			// ajax提交方式

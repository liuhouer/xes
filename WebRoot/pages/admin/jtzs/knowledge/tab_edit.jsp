...
<div class="up72_edit">
  <form:form id="admin_jtzs_knowledge_tab_edit_form" method="put" action="${ctx}/admin/jtzs/knowledge/${knowledge.id}" modelAttribute="knowledge">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_jtzs_knowledge_tab_edit_form").validate({
			/*  
			// ajax提交方式

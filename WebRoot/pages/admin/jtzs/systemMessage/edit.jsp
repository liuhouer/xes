...
<div class="up72_edit">
  <form:form id="admin_jtzs_systemMessage_edit_form" method="put" action="${ctx}/admin/jtzs/systemMessage/${systemMessage.id}" modelAttribute="systemMessage">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_jtzs_systemMessage_edit_form").validate({
			/*  
			// ajax提交方式

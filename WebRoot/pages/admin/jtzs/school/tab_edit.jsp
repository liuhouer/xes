...
<div class="up72_edit">
  <form:form id="admin_jtzs_school_tab_edit_form" method="put" action="${ctx}/admin/jtzs/school/${school.id}" modelAttribute="school">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_jtzs_school_tab_edit_form").validate({
			/*  
			// ajax提交方式

...
<div class="up72_edit">
  <form:form id="admin_jtzs_student_tab_edit_form" method="put" action="${ctx}/admin/jtzs/student/${student.id}" modelAttribute="student">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_jtzs_student_tab_edit_form").validate({
			/*  
			// ajax提交方式

...
<%@page import="com.xes.jtzs.model.Student"%>
<%@ include file="/common/taglibs.jsp" %>
<div class="up72_edit">
  <form:form id="admin_jtzs_student_edit_form" method="post" action="${ctx}/admin/jtzs/student/${student.id}/doEditPassword">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_jtzs_student_edit_form").validate({
			/*  
			// ajax提交方式

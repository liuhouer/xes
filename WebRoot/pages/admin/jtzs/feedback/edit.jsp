...
<div class="up72_edit">
  <form:form id="admin_jtzs_feedback_edit_form" method="put" action="${ctx}/admin/jtzs/feedback/${feedback.id}" modelAttribute="feedback">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_jtzs_feedback_edit_form").validate({
			/*  
			// ajax提交方式

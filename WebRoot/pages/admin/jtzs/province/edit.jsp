...
<div class="up72_edit">
  <form:form id="admin_jtzs_province_edit_form" method="put" action="${ctx}/admin/jtzs/province/${province.id}" modelAttribute="province">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_jtzs_province_edit_form").validate({
			/*  
			// ajax提交方式

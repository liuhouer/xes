...
<div class="up72_edit">
  <form:form id="admin_jtzs_scoreLog_edit_form" method="put" action="${ctx}/admin/jtzs/scoreLog/${scoreLog.id}" modelAttribute="scoreLog">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_jtzs_scoreLog_edit_form").validate({
			/*  
			// ajax提交方式

...
<div class="up72_edit">
  <form:form id="admin_jtzs_grade_tab_edit_form" method="put" action="${ctx}/admin/jtzs/grade/${grade.id}" modelAttribute="grade">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_jtzs_grade_tab_edit_form").validate({
			/*  
			// ajax提交方式

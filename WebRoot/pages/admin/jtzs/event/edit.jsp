...
<div class="up72_edit">
  <form:form id="admin_jtzs_event_edit_form" method="put" action="${ctx}/admin/jtzs/event/${event.id}" modelAttribute="event">
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="edit_table">
      <%@ include file="form_include.jsp" %>
    </table>
    <div class="up72_submit">
      <div class="btn btn_sub" title="完成"><input type="button" onclick="checkQuestion()" id="submitButton" name="submitButton" value="完成" /></div>

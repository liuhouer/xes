...
<div class="up72_edit">
  <form:form id="admin_jtzs_commonRule_tab_edit_form" method="put" action="${ctx}/admin/jtzs/commonRule/${commonRule.id}" modelAttribute="commonRule">
...
<script type="text/javascript">
	$(document).ready(function(){
		$("#admin_jtzs_commonRule_tab_edit_form").validate({
			/*  
			// ajax提交方式

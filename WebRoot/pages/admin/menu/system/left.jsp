...
<ul id="jsddm">
     <li> <a href="javascript:;" style="padding:0;"><img src="${ctx}/styles/system/skins/mac/images/logo_png.png" width="46" height="32" /></a>
        <ul>
          <li><a href="${ctx}/admin/deskTop">个人桌面</a></li>
          <li><a href="${ctx}/admin/goProduct/17">系统设置</a></li>
...
<script type="text/javascript">
	...
	$(permJson).each(function(i,group){
		...
		$(group.permList).each(function(j,perm){
			html += "<li>";
			html += "<a href='javascript:;' onclick=\"$.forward('${ctx}"+perm.url+"',"+perm.id+");\" title='"+perm.name+"' >";
			html += perm.name;
			html += "</a>";
			html += "</li>";
		});

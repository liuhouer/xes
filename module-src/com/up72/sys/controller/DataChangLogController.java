...
@Controller
@RequestMapping("/sys/dataChangLog")
public class DataChangLogController extends BaseRestSpringController<DataChangLog,java.lang.Long>{
	//默认多列排序,example: username desc,createTime asc
	protected static final String DEFAULT_SORT_COLUMNS = null; 
	
	private DataChangLogManager dataChangLogManager;
	
	private final String LIST_ACTION = "redirect:/sys/dataChangLog";
	...
	public String index(ModelMap model,DataChangLogQuery query,HttpServletRequest request,HttpServletResponse response) {
		Page page = this.dataChangLogManager.findPage(query);
		
		model.addAllAttributes(toModelMap(page, query));
		return "/sys/dataChangLog/index";
	}

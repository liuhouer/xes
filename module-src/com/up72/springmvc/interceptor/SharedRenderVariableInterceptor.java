package com.up72.springmvc.interceptor;
...
import com.up72.framework.web.httpinclude.HttpInclude;
...
public class SharedRenderVariableInterceptor extends HandlerInterceptorAdapter implements InitializingBean{
	...
	protected Map<String,Object> perRequest(HttpServletRequest request,HttpServletResponse response) {
		...
		model.put("share_current_login_username", "up72");
	...
	private void initSharedRenderVariables() {
		...
		globalRenderVariables.put("url_prefix", "http://www.up72.com");
		globalRenderVariables.put("img_url_prefix", "http://img.up72.com");
		globalRenderVariables.put("media_url_prefix", "http://media.up72.com");
		globalRenderVariables.put("static_url_prefix", "http://static.up72.com");
